function varargout = GUI_ref_asc_desc_manual(varargin)
% GUI_REF_ASC_DESC_MANUAL MATLAB code for GUI_ref_asc_desc_manual.fig
%      GUI_REF_ASC_DESC_MANUAL, by itself, creates a new GUI_REF_ASC_DESC_MANUAL or raises the existing
%      singleton*.
%
%      H = GUI_REF_ASC_DESC_MANUAL returns the handle to a new GUI_REF_ASC_DESC_MANUAL or the handle to
%      the existing singleton*.
%
%      GUI_REF_ASC_DESC_MANUAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_REF_ASC_DESC_MANUAL.M with the given input arguments.
%
%      GUI_REF_ASC_DESC_MANUAL('Property','Value',...) creates a new GUI_REF_ASC_DESC_MANUAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_ref_asc_desc_manual_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 04-Dec-2020 17:45:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_ref_asc_desc_manual_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_ref_asc_desc_manual_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GUI_ref_asc_desc_manual_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GUI_ref_asc_desc_manual_OutputFcn(hObject, eventdata, handles) 
